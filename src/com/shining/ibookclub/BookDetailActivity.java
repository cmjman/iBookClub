...
public class BookDetailActivity extends Activity {
	...
	private WebView webview_BookDetail;
...
//	private MyBookDao myBookdao;
	...
	//	final View contentView = findViewById(R.id.fullscreen_content);
		webview_BookDetail=(WebView)findViewById(R.id.webview_BookDetail);

		// Set up an instance of SystemUiHider to control the system UI for
		// this activity.
		mSystemUiHider = SystemUiHider.getInstance(this, webview_BookDetail,
				HIDER_FLAGS);
		...
		webview_BookDetail.setOnClickListener(new View.OnClickListener() {
			@Override
...
//		findViewById(R.id.dummy_button).setOnTouchListener(
	...
	//	MyBookDao.initMyBookDao(this);
		...
		webview_BookDetail.getSettings().setSupportZoom(false);
		webview_BookDetail.getSettings().setJavaScriptCanOpenWindowsAutomatically(
				true);
		webview_BookDetail.getSettings().setJavaScriptEnabled(true);

		
		
		
     	webview_BookDetail.addJavascriptInterface(new Object() {
